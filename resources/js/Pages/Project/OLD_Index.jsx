...
export default function Project({ projects, queryParams = null , success }) {
                    ...
                    {projects.data.map((project) => (
                      ...
                      >
                        ...
                        <td className="px-3 py-2">
                          <img src={project.imagPath} style={{ width: 60 }} />
                        </td>
                        <td className="px-3 py-2">
                          <Link
                        ...
                        <td className="px-3 py-2">
                          <Link
                            ...
                            className="font-medium text-blue-600 hover:text-blue-500 hover:underline mx-1"
                          >
                            Edit
                          </Link>
                          ...
                          <Link
                            ...
                            className="font-medium text-red-600 hover:text-red-500 hover:underline mx-1"
                          >
                            Delete
                          </Link>
                        </td>
